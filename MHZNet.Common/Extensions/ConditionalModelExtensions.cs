...
namespace MHZNet.Common.Extensions;
...
public static class ConditionalModelExtensions
{
        ...
        PropertyInfo propertyInfo, object fieldValue)
    {
        ...
        //多字段查�?        if (queryConditionAttribute.FieldNameItems.Length > 0)
        {
        ...
        conditionalModels.Add(new ConditionalModel()
        {
            FieldName = UtilMethods.ToUnderLine(fieldName), // 字段名要跟SqlSugarSetup配置的一�?            ConditionalType = queryConditionAttribute.ConditionType,
