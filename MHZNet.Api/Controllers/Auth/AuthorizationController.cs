...
using MHZNet.Api.ActionExtension.Parameter;
...
using MHZNet.IBusiness.Queued;
using MHZNet.IBusiness.System;
using MHZNet.Infrastructure.Authentication;
using MHZNet.DTO.Queries.Login;
...
namespace MHZNet.Api.Controllers.Auth;
...
public class AuthorizationController : BaseApiController
{
    ...
    public async Task<ActionResult> RefreshToken(string token)
    {
        ...
        if (jwtSecurityToken != null)
        {
            ...
            // 允许token刷新时间�?            if (nowTime <= refreshTime)
            {
