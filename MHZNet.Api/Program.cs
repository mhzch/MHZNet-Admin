...
using MHZNet.Common.IdGenerator.Contract;
using MHZNet.Common.MultiLanguage.Resources;
using MHZNet.Core;
using MHZNet.Core.ConfigOptions;
using MHZNet.Core.Internal;
using MHZNet.Core.Mapping;
using MHZNet.Infrastructure.ActionFilter;
using MHZNet.Infrastructure.Extensions;
using MHZNet.Infrastructure.Middleware;
using Autofac;
...
builder.Services.AddSession(options =>
{
    ...
    options.Cookie.IsEssential = true; // 确保在没有同意Cookie 的情况下也能使用
});
